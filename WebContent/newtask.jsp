...
<html>
	...
	<body>
			...
			<div class="content">
				<div class="container">
					<form action="#">
						<pre>    TITLE: 	                    <input type="text" /></pre><br>
						<pre>    DATE DUE: 	    <input type="date" /></pre><br>
						<pre>    DESCRIPTION:       <input type="text" /></pre><br>
					</form>
					<div class="sign-ligin-btns2">
					<ul>
						<li id="signupContainer"><a class="signup" id="signupButton" href="mycalendar.html"><span><i>Add Task</i></span></a>
							 <div class="clear"> </div>
						</li>
					</ul>
					</div>
